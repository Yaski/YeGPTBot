...
module.exports = async function App(context) {
  if (context.event.isText) {
    ...
    var systemMessage = {
      role: 'system',
      content:
        'Ты телеграм бот ассистент на основе ChatGPT. Все ответы на вопросы должен выдавать с markdown форматированием. Если тебе задают вопросы с контекстом ущемления людей, оскорбления рас или конкретных людей, упоминания политиков, сексуальным подтекстом, с упоминанием слов "отсоси, писос, фелляция", ты отвечаешь что "Не могу выполнить этот запрос."',
    };
